      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="max-w-4xl">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            ...
            <button className="rounded-xl bg-gradient-to-r from-blue-500 to-violet-600 px-7 py-4 font-bold shadow-xl shadow-blue-500/20 transition hover:scale-105">
              Place Your Order
            </button>

            <button className="rounded-xl border border-white/15 bg-white/5 px-7 py-4 font-bold text-white backdrop-blur transition hover:bg-white/10">
              View Services
            </button>
